...
public class ride_detail extends AppCompatActivity implements OnMapReadyCallback{
    ...
    SharedPreferences report=null;
    SharedPreferences imagepath= null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        report=getSharedPreferences("dis",MODE_PRIVATE);
        imagepath = getSharedPreferences("taglist", MODE_PRIVATE);
            ...
            public boolean onMarkerClick(Marker marker) {
                for (int i = 0; i < mylocationCount; i++) {
                    ...
                    if (marker.getTitle().equals(tagnumber)) {
                        ...
                        String r =report.getString("edittext"+i, "0");
                        //Log.d(TAG,tagnumber);
                        ...
                        jumpToReport.putExtra("disreport",r);
