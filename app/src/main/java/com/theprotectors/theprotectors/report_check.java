...
public class report_check extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        get= getSharedPreferences("reason",MODE_PRIVATE);
        ...
        text= (EditText) this.findViewById(R.id.editText3);
        ...
        //image();
        String title = get.getString("SpinnerReasons"+number,"0");
        this.setTitle(title);
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        report=getIntent().getStringExtra("disreport");
        drawMarker(fromPosition);
        text.setText(report);
        Log.d(TAG, report + "    OKKKK");
        putImage();
    }
